...
exports.createTicket = function createTicket(signerDN, dstDN, service, TicketTime) {
    ...
    var loginTicketRequestXml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
        + "<loginTicketRequest version=\"1.0\">"
        + "<header>"
        + "<source>"
        + "C=AR, O=Ritenere SA, SERIALNUMBER=CUIT 30700627825, CN=fintest"//signerDN
        + "</source>"
        + "<destination>"
        + "CN=wsaahomo, O=AFIP, C=AR, SERIALNUMBER=CUIT 33693450239"//dstDN
        + "</destination>"
        + "<uniqueId>"
        + uniqueId
        + "</uniqueId>"
